...
public class User implements Serializable{
    ...
    public User(int id , String mail, String firebaseId, String firstnName, String lastName,
    ...
    public User(String mail, String firebaseId, String firstnName, String lastName,
                String username, Date birthDate, String city)
    {
        this.firebaseId = firebaseId;
        this.mail = mail;
